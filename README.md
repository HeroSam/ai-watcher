...
2. Create a .env file with your FreeTheAI API key:
   text
...
1. Join the FreeTheAI Discord server: discord.gg/secrets
2. Run /signup to get your API key.
3. Run /checkin daily to activate it.
